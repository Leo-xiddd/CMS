// 公共变量
function getHostUrl(){
    return "http://S-BEMP.tech.bitauto.com:8080/EAS/";
}
// 浏览器兼容 取得浏览器可视区高度 
...
function close_alerm(){
  var ovelay='#overlay';
  if($("#form_alert").css('z-index')=='9')ovelay='#overlay2';
  $("#form_alert").css('z-index','5');
  CloseForm('#form_alert',ovelay);
}