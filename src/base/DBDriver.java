...
public class DBDriver {
	...
	static String logconf=rootpath+File.separator+"conf"+File.separator+"CMS"+File.separator+"logconf.properties";
	static String sysconf=rootpath+File.separator+"conf"+File.separator+"CMS"+File.separator+"Sys_config.xml";
